...
[SDL2](https://www.libsdl.org/) and [Pixman](https://www.pixman.org/) are required for enabling virtio-gpu.
To install them on Debian/Ubuntu Linux, enter the following command:
