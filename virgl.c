                                   ...
                                   uint32_t *plen)
{
    ...
    window_setup_scanout(scanout_id, res_info.tex_id);
                                     ...
                                     uint32_t *plen)
{
    ...
    cursor_update_gl(request->pos.scanout_id, cursor_data);
                                   ...
                                   uint32_t *plen)
{
    ...
    cursor_move_gl(cursor->pos.scanout_id, cursor->pos.x, cursor->pos.y);
